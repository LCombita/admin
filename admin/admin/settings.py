...
SECRET_KEY = 'django-insecure-x^1kp$sy_n!2$r(kqkz02%#=65v!+#ghyf7yoz_d@*3=!m&7!!'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'templates')], #hacer los templates en un directorio fuera de la 
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
