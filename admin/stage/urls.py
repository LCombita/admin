...
from .views import ImpuestoRepartoEtapaEditView, RepartoEtapaDetailView, ObservacionesRepartoEtapa2EditView, ObservacionCreateView
...
stage_patterns = ([
    ...
    path('ret-obs3/<int:id>', ObservacionCreateView.as_view(), name='repartoetapa-observaciones3'),
    #REVISION
